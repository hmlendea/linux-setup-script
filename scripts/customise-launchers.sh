...
set_launcher_entry "${GLOBAL_LAUNCHERS_PATH}/visual-studio-code.desktop" X-GNOME-FullName "Visual Studio Code;"
set_launcher_entry "${GLOBAL_LAUNCHERS_PATH}/visual-studio-code.desktop" X-MATE-FullName "Visual Studio Code;"
