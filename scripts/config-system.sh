...
if [ -f "/usr/bin/gnome-shell" ]; then
    ...
    set_gsetting "org.gnome.desktop.wm.preferences" titlebar-font "Roboto 11"
    ...
    set_gsetting "org.gnome.desktop.interface" document-font-name "Noto Sans 11"
    set_gsetting "org.gnome.desktop.interface" font-name "Noto Sans 11"
    set_gsetting "org.gnome.desktop.interface" monospace-font-name "Noto Sans Mono 12"
